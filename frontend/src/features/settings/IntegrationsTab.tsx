                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-white flex items-center gap-2">
                                {mod.name}
                                {enabledModules.includes(mod.id) && <span className="text-[10px] bg-emerald-500/10 text-emerald-500 px-2 py-0.5 rounded-full border border-emerald-500/20">ACTIVE</span>}
                            </h4>
